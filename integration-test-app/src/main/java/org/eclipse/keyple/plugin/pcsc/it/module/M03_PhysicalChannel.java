  ...
  protected List<Scenario> buildScenarios() {
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "isCardPresent() with card present: connects and returns ATR";
          }

          public String getRequiredEquipment() {
            return "Any card in the reader";
          }
            ...
            try {
              ...
              if (!present) {
                return ScenarioResult.fail(
                    getId(), "isCardPresent() returned false but card was inserted");
              }
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "isCardPresent() is idempotent when card stays present";
          }
            ...
            try {
              ...
              if (p1 && p2 && atr1.equals(atr2)) {
                return ScenarioResult.pass(
                    getId(), "Second isCardPresent() was no-op; ATR unchanged: " + atr1);
              }
              return ScenarioResult.fail(
                  getId(), "p1=" + p1 + " p2=" + p2 + " atr1=" + atr1 + " atr2=" + atr2);
            } catch (Exception e) {
              return ScenarioResult.fail(getId(), e.getMessage());
            }
          }
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "After deselectCard(), isCardPresent() reconnects";
          }
          ...
          public ScenarioResult run(ValidationContext ctx) {
            ...
            try {
              ...
              if (p1 && p2) {
                return ScenarioResult.pass(
                    getId(), "Reconnected after deselectCard(); ATR: " + atr2);
              }
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "isCardPresent() with each DisconnectionMode";
          }
