...
import org.eclipse.keyple.plugin.pcsc.it.util.ApduBuilder;
  ...
  protected List<Scenario> buildScenarios() {
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "GET CHALLENGE (works on most ISO cards)";
          }

          public String getRequiredEquipment() {
            return "Any ISO 7816 card";
          }
            ...
            try {
              ...
              if (ApduBuilder.isOk(resp)) {
                return ScenarioResult.pass(
                    getId(), "GET CHALLENGE -> SW=" + ApduBuilder.swHex(resp));
              }
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "SELECT Master File (00 A4 00 00)";
          }
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "User-defined APDU (enter hex command)";
          }
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "Card removal during APDU -> CardIOException";
          }
          ...
          public ScenarioResult run(ValidationContext ctx) {
            ...
            try {
              ...
              return ScenarioResult.fail(
                  getId(),
                  "Wrong exception type: " + e.getClass().getSimpleName() + " - " + e.getMessage());
            }
          }
        });
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "Sequential APDUs: 5x GET CHALLENGE";
          }
