  ...
  protected List<Scenario> buildScenarios() {
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "Plugin name equals 'PcscPlugin'";
          }
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "List all connected PC/SC readers";
          }
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "Auto-detect contact vs contactless by reader name";
          }
          ...
          public ScenarioResult run(ValidationContext ctx) {
            ...
            for (CardReader r : plugin.getReaders()) {
              if (r.isContactless()) contactless++;
              else contact++;
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "Custom contactless identification filter (user regex)";
          }
          ...
          public ScenarioResult run(ValidationContext ctx) {
            ...
            try {
              ...
              for (CardReader r : plugin.getReaders()) {
                console.info(
                    r.getName() + " -> " + (r.isContactless() ? "contactless" : "contact"));
              }
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "Verify PcscPlugin extension is accessible";
          }
          ...
          public ScenarioResult run(ValidationContext ctx) {
            try {
              ...
              if (ext != null) {
                return ScenarioResult.pass(
                    getId(), "getExtension(PcscPlugin.class) returned non-null");
              }
