  ...
  protected List<Scenario> buildScenarios() {
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "Sharing mode: EXCLUSIVE then back to SHARED";
          }
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "ISO protocol: cycle through ANY / T0 / T1 / TCL";
          }
          ...
          public ScenarioResult run(ValidationContext ctx) {
            ...
            for (PcscReader.IsoProtocol proto : PcscReader.IsoProtocol.values()) {
              ...
              console.info(
                  "setIsoProtocol(" + proto.name() + ") -> value=\"" + proto.getValue() + "\"");
            }
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "Disconnection mode: cycle through RESET / LEAVE / UNPOWER / EJECT";
          }
    ...
    list.add(
        new Scenario() {
          ...
          public String getTitle() {
            return "setContactless() override (true then false)";
          }
          ...
          public ScenarioResult run(ValidationContext ctx) {
            ...
            if (restored) {
              return ScenarioResult.pass(
                  getId(), "setContactless() override works; original value restored");
            }
