...
public final class M10_Deselection extends AbstractModule {
  ...
  protected List<Scenario> buildScenarios() {
    ...
    list.add(
        new Scenario() {
          public String getId() { return "M10.1"; }
          public String getTitle() { return "deselectCard() puts contactless card in HALT; powerOnData preserved"; }
          public String getRequiredEquipment() { return "ISO 14443-4 contactless card"; }
            ...
            try {
              ...
              if (atrPreserved) {
                return ScenarioResult.pass(getId(),
                    "ATR preserved after deselectCard(): " + atrAfter);
              }
    ...
    list.add(
        new Scenario() {
          public String getId() { return "M10.2"; }
          public String getTitle() { return "Re-present card after deselectCard() -> new detection possible"; }
          public String getRequiredEquipment() { return "ISO 14443-4 contactless card"; }
          ...
          public ScenarioResult run(ValidationContext ctx) {
            ...
            try {
              ...
              ctx.getConsole().waitForEnterOrTimeout(
                  "Re-present the card (or leave it on the reader)", 10_000);
              ...
              if (p2) {
                ...
                return ScenarioResult.pass(getId(), "Card re-detected; ATR1=" + atr1 + " ATR2=" + atr2);
              }
    ...
    list.add(
        new Scenario() {
          public String getId() { return "M10.3"; }
          public String getTitle() { return "deselectCard() on closed channel is a no-op"; }
