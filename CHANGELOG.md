...
### Added
- Add configurable card monitoring duration cycle through a new method `setCardMonitoringDurationCycle(int durationCycle)` to set the card monitoring duration cycle
