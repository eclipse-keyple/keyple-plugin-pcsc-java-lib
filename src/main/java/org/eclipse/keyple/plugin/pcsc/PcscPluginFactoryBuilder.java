...
public final class PcscPluginFactoryBuilder {
  ...
  public static class Builder {
    ...
    private int cardMonitoringDurationCycle = 500; // default value 500 ms
    ...
    /**
     * Sets the duration cycle for card monitoring (insertion and removal).
     *
     ...
     *
     * @param durationCycle The duration cycle for card monitoring, in milliseconds, in range
     *     [1..500].
     * @return This builder.
     * @throws IllegalArgumentException If the provided value is out of range.
     * @since 2.4.0
     */
    public Builder setCardMonitoringDurationCycle(int durationCycle) {
      Assert.getInstance().isInRange(durationCycle, 1, 500, "durationCycle");
      cardMonitoringDurationCycle = durationCycle;
      return this;
    }
